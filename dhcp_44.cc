...
int main(int argc, char *argv[])
{
    ...
    Ipv4InterfaceContainer fixedNodes = dhcpHelper.InstallFixedAddress(busDevices.Get(4), Ipv4Address("10.0.0.17"), Ipv4Mask("/8"));
    ...
    ApplicationContainer dhcpServerApp = dhcpHelper.InstallDhcpServer(busDevices.Get(3), Ipv4Address("10.0.0.12"), Ipv4Address("10.0.0.0"), Ipv4Mask("/8"), Ipv4Address("10.0.0.1"), Ipv4Address ("10.0.0.15"), Ipv4Address("10.0.0.17"));
